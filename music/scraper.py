# https://raw.githubusercontent.com/datalivre/web-scraping/master/scra.py
...
def get_links(band):
    ...
    try:
        ...
        for link in bs.find('div', {'class': 'cnt-list--alp'}).find_all('a'):
